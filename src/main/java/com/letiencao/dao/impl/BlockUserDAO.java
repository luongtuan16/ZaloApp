...
public class BlockUserDAO extends BaseDAO<BlocksModel> implements IBlockUserDAO{
	...
	public Long insertOne(BlocksModel blocksModel) {
		String sql = 
				"INSERT INTO block_mess(deleted,createddate,createdby,idBlocks,idBlocked) VALUES(?,?,?,?,?)";
		return insertOne(sql, blocksModel.isDeleted(),blocksModel.getCreatedDate(),
				blocksModel.getCreatedBy(),blocksModel.getIdBlocks(),blocksModel.getIdBlocked());
	}
